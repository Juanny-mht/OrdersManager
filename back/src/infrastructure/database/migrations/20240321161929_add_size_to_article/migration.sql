/*
  ...
  - Added the required column `size` to the `ArticleId` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_ArticleId" ("id", "orderId") SELECT "id", "orderId" FROM "ArticleId";
